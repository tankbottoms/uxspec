...
.badge.w7  { width: 7ch; }
.badge.w9  { width: 9ch; }
.badge.w11 { width: 11ch; }
.badge.w12 { width: 12ch; }
.badge.w14 { width: 14ch; }
.badge.w17 { width: 17ch; }
.badge.w19 { width: 19ch; }
.badge.w23 { width: 23ch; }
.badge.w25 { width: 25ch; }
...
.badge.auto { width: auto; min-width: 9ch; }
.badge.w30 { width: 30ch; }
.badge.w34 { width: 34ch; }
...
.badge.w38 { width: 38ch; }
.badge.w42 { width: 42ch; }
...
/* Colour without fill. A payee sitting under its category is the same colour as the
   category and must not compete with it, so it keeps the border and the text and
   gives up the background. */
.badge.hollow { background: var(--paper-card); }
/* Ink on paper, for a column that is a label rather than a value -- a month name
   carries no status and should not borrow a status colour to say so. */
...
tr.sep > td {
  ...
  color: var(--ink-muted); font-size: 11px; letter-spacing: .08em;
